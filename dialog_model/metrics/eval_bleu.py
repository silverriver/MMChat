...
def eval_bleu_detail(ref, pred):
    ...
    return corpus_bleu(ref, pred, weights=[1, 0, 0, 0], smoothing_function=smooth.method1),\
           corpus_bleu(ref, pred, weights=[0.5, 0.5, 0, 0], smoothing_function=smooth.method1), \
           corpus_bleu(ref, pred, weights=[0.333, 0.333, 0.333, 0], smoothing_function=smooth.method1), \
           corpus_bleu(ref, pred, weights=[0.25, 0.25, 0.25, 0.25], smoothing_function=smooth.method1)
