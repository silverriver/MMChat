...
class Vocab:
    ...
    def __init__(self, vocab_file):
        ...
        added_spec_tokens = [Vocab.P1, Vocab.P2, Vocab.WEIBO, Vocab.OBJECT, Vocab.CAPTION, Vocab.IMG, Vocab.BOS, Vocab.CLS]
    ...
    @property
    def object_token_id(self):
        return self.token2id[Vocab.OBJECT]

    @property
    def caption_token_id(self):
        return self.token2id[Vocab.CAPTION]
