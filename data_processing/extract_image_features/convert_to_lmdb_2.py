...
def get_parser():
    ...
    parser.add_argument(
        "--features_dir", default='sample_img_feature', type=str, help="Path to extracted features file"
    )
    parser.add_argument(
        "--lmdb_file", default='lmdb_feature', type=str, help="Path to generated LMDB file"
    )
    return parser
